document.addEventListener("DOMContentLoaded", () => {
  ...
  const loadQuestion = () => {
    ...
    // Agrega las nuevas opciones como radio buttons
    currentQuestion.options.forEach((option, index) => {
      ...
      label.innerHTML = `
        ...
        ${option}
      `;
      label.style.display = "block"; // Asegura que cada opción esté en una nueva línea
      optionsElement.appendChild(label);
    });

    // Habilita el botón "Siguiente" solo cuando se selecciona una opción
